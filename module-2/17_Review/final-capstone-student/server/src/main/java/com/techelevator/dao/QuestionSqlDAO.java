...
public class QuestionSqlDAO implements  QuestionDAO{
    ...
    public Question createQuestion(Question q) {
        String sql = "INSERT into question(title,question) VALUES(?,?) RETURNING question_id;";
    ...
    public List<Question> filter(String title, String question) {
        ...
        String sql = "select title, question_id, question from question where title ilike ? and question ilike ? ";
        title = "%"+title+"%";
        question = "%"+question+"%";

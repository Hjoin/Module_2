...
@Component  //anytime spring framework creates a controller or new object that needs a hoteldao as a parameter
            // to the constructor, create a new MemoryHotelDAO and pass that in

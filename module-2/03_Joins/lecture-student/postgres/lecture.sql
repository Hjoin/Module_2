...
-- what dtate in the US has the most cities in the database
SELECT district, COUNT(*)
FROM city
WHERE countrycode = 'USA'
GROUP BY district
...
SELECT first_name --200 (duplicates removed)
FROM actor
UNION
SELECT first_name --599 (duplicates removed)
FROM customer;

-- Gather the list, but this time note the source table with 'A' for actor and 'C' for customer
SELECT first_name, 'A' --200 (duplicates removed)
FROM actor
UNION
SELECT first_name, 'C' --599 (duplicates removed)
FROM customer;
